...
python cql_exp/baseline/cql_base.py --setting ${SLURM_ARRAY_TASK_ID} --seed 42 &
python cql_exp/baseline/cql_base.py --setting ${SLURM_ARRAY_TASK_ID} --seed 666 &
python cql_exp/baseline/cql_base.py --setting ${SLURM_ARRAY_TASK_ID} --seed 1024
"