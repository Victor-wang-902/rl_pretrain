...
python SimpleSAC/run_cql.py --env hopper --dataset medium &
python SimpleSAC/run_cql.py --env hopper --dataset medium-replay &
python SimpleSAC/run_cql.py --env hopper --dataset medium-expert &
python SimpleSAC/run_cql.py --env walker2d --dataset medium &
python SimpleSAC/run_cql.py --env walker2d --dataset medium-replay
"