...
python SimpleSAC/run_cql.py --env walker2d --dataset medium-expert  --seed 666 &
python SimpleSAC/run_cql.py --env halfcheetah --dataset medium  --seed 666 &
python SimpleSAC/run_cql.py --env halfcheetah --dataset medium-replay  --seed 666 &
python SimpleSAC/run_cql.py --env halfcheetah --dataset medium-expert --seed 666
"