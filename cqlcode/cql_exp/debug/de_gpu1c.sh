...
python SimpleSAC/run_cql.py --env hopper --dataset medium --seed 1024 &
python SimpleSAC/run_cql.py --env hopper --dataset medium-replay --seed 1024 &
python SimpleSAC/run_cql.py --env hopper --dataset medium-expert --seed 1024 &
python SimpleSAC/run_cql.py --env walker2d --dataset medium --seed 1024 &
python SimpleSAC/run_cql.py --env walker2d --dataset medium-replay --seed 1024
"