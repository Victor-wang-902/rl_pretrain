...
python SimpleSAC/run_cql.py --env walker2d --dataset medium-expert &
python SimpleSAC/run_cql.py --env halfcheetah --dataset medium &
python SimpleSAC/run_cql.py --env halfcheetah --dataset medium-replay &
python SimpleSAC/run_cql.py --env halfcheetah --dataset medium-expert
"