...
python cql_exp/pretrain_abl/large_arch.py --setting ${SLURM_ARRAY_TASK_ID} --qf_hidden_layer 4 &
python cql_exp/pretrain_abl/large_arch.py --setting ${SLURM_ARRAY_TASK_ID} --qf_hidden_layer 6 &
python cql_exp/pretrain_abl/large_arch.py --setting ${SLURM_ARRAY_TASK_ID} --qf_hidden_layer 8
"