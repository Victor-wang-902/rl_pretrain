...
python SimpleSAC/run_cql.py --exp_prefix pre_only --do_pretrain_only True --env hopper --dataset medium &
python SimpleSAC/run_cql.py --exp_prefix pre_only --do_pretrain_only True --env hopper --dataset medium-replay &
python SimpleSAC/run_cql.py --exp_prefix pre_only --do_pretrain_only True --env hopper --dataset medium-expert
"