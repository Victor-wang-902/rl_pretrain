...
#SBATCH --array=0-125 # here the number depends on number of tasks in the array, e.g. 0-11 will create 12 tasks
...
python exp/new100/mdp_s100k2.py --setting ${SLURM_ARRAY_TASK_ID}
"