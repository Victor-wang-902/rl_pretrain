...
#SBATCH --array=0-161 # here the number depends on number of tasks in the array, e.g. 0-11 will create 12 tasks
...
sleep $(( (RANDOM%50) + 1 )) # to avoid issues when submitting large amounts of jobs
