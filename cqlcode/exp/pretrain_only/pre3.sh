...
sleep $(( (RANDOM%7) + 1 )) # to avoid issues when submitting large amounts of jobs
...
python SimpleSAC/run_cql.py --exp_prefix pre_only --pretrain_mode q_sprime --do_pretrain_only True --env walker2d --dataset medium &
python SimpleSAC/run_cql.py --exp_prefix pre_only --pretrain_mode q_sprime --do_pretrain_only True --env walker2d --dataset medium-replay &
python SimpleSAC/run_cql.py --exp_prefix pre_only --pretrain_mode q_sprime --do_pretrain_only True --env walker2d --dataset medium-expert
"