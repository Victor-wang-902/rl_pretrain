...
python exp/newbaselines/larger_gpu.py --setting ${SLURM_ARRAY_TASK_ID} --seed 42 &
python exp/newbaselines/larger_gpu.py --setting ${SLURM_ARRAY_TASK_ID} --seed 666 &
python exp/newbaselines/larger_gpu.py --setting ${SLURM_ARRAY_TASK_ID} --seed 1024
"