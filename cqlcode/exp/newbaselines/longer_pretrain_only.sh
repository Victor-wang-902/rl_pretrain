...
python exp/newbaselines/longer_pretrain_only.py --setting ${SLURM_ARRAY_TASK_ID} --dataset medium &
python exp/newbaselines/longer_pretrain_only.py --setting ${SLURM_ARRAY_TASK_ID} --dataset medium-replay &
python exp/newbaselines/longer_pretrain_only.py --setting ${SLURM_ARRAY_TASK_ID} --dataset medium-expert
"
