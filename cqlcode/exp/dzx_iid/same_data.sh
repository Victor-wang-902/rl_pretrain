...
#SBATCH --array=0-4 # here the number depends on number of tasks in the array, e.g. 0-11 will create 12 tasks
...
python exp/dzx_iid/same_data.py --setting ${SLURM_ARRAY_TASK_ID}
"
