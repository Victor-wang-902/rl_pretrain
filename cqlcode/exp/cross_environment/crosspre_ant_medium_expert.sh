...
#SBATCH --array=0-288 # TODO calculate the number of tasks in the array, e.g. 0-11 will create 12 tasks
...
python exp/cross_environment/crosspre_ant_medium_expert.py --setting ${SLURM_ARRAY_TASK_ID}
"