...
python SimpleSAC/run_cql.py --env walker2d --dataset medium-expert  --seed 1024 &
python SimpleSAC/run_cql.py --env halfcheetah --dataset medium  --seed 1024 &
python SimpleSAC/run_cql.py --env halfcheetah --dataset medium-replay  --seed 1024 &
python SimpleSAC/run_cql.py --env halfcheetah --dataset medium-expert --seed 1024
"