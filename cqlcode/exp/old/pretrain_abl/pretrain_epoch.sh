...
python cql_exp/pretrain_abl/pretrain_epoch.py --setting ${SLURM_ARRAY_TASK_ID} --seed 42 &
python cql_exp/pretrain_abl/pretrain_epoch.py --setting ${SLURM_ARRAY_TASK_ID} --seed 666 &
python cql_exp/pretrain_abl/pretrain_epoch.py --setting ${SLURM_ARRAY_TASK_ID} --seed 1024
"