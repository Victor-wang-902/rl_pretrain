...
#SBATCH --array=0-24 # here the number depends on number of tasks in the array, e.g. 0-11 will create 12 tasks
...
python experiments/mdp/baseline_again.py --setting ${SLURM_ARRAY_TASK_ID}
"