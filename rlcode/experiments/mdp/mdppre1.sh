...
#SBATCH --array=0-49 # here the number depends on number of tasks in the array, e.g. 0-11 will create 12 tasks
...
python experiments/mdp/mdppre1.py --setting ${SLURM_ARRAY_TASK_ID}
"