...
#SBATCH --array=0-611 # here the number depends on number of tasks in the array, e.g. 0-11 will create 12 tasks
...
python exp_scripts/exp/chibit-syn_20seeds_2.py --setting ${SLURM_ARRAY_TASK_ID} --device cpu --extend_positions --dropout 0.2 --share_input_output_proj
"