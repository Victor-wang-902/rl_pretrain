...
python exp_scripts/exp/dt_rerun_20seeds_analysis.py --setting ${SLURM_ARRAY_TASK_ID} --device cpu --dropout 0.2 --calculate_extra
python exp_scripts/exp/dt_rerun_20seeds_analysis.py --setting ${SLURM_ARRAY_TASK_ID} --device cpu --dropout 0.2 --calculate_extra --compare_w_pretrain
