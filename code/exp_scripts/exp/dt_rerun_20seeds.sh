...
#SBATCH --array=0-203 # here the number depends on number of tasks in the array, e.g. 0-11 will create 12 tasks
...
python exp_scripts/exp/dt_rerun_20seeds.py --setting ${SLURM_ARRAY_TASK_ID} --device cpu --dropout 0.2
"