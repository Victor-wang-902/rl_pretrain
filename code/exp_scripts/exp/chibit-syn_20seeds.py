...
if __name__ == '__main__':
    ...
    settings = [
        ...
        'pretrained_lm', 'step', [("/scratch/zw2374/public/can-wikipedia-help-offline-rl-old/ngram/pretrain/checkpoints_ngram/chibiT_syn_embed_dim128_n_layer3_n_head1_ngram_1_nvocab_100_temperature_1.0_rerun_2/model_8000", "8000"), 
        ("/scratch/zw2374/public/can-wikipedia-help-offline-rl-old/ngram/pretrain/checkpoints/chibiT_syn_embed_dim128_n_layer3_n_head1_ngram_1_nvocab_100_temperature_1.0/model_20000", "20000"), 
        ("/scratch/zw2374/public/can-wikipedia-help-offline-rl-old/ngram/pretrain/checkpoints/chibiT_syn_embed_dim128_n_layer3_n_head1_ngram_1_nvocab_100_temperature_1.0/model_40000", "40000"),
        ]        ]
