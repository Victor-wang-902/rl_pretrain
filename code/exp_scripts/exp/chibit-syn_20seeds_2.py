...
if __name__ == '__main__':
    ...
    exp_prefix = 'chibiT-syn-20seeds-steps-wo_2'
    # env, dataset and seed values will be added to the end of the folder name string
    # for each 3-tuple,
    settings = [
        'env', '', MUJOCO_4_ENVS,
        'dataset', '', MUJOCO_3_DATASETS,
        'seed', '', [6331, 6049, 3785, 9329, 2901, 7929, 4598, 9051, 5599, 6183, 7282, 7127, 5575, 4493, 3406, 8958, 684],
        'pretrained_lm', 'step', [("/scratch/zw2374/public/can-wikipedia-help-offline-rl-old/ngram/pretrain/checkpoints/chibiT_syn_embed_dim128_n_layer3_n_head1_ngram_1_nvocab_100_temperature_1.0/model_10000", "10000"), 
        ("/scratch/zw2374/public/can-wikipedia-help-offline-rl-old/ngram/pretrain/checkpoints/chibiT_syn_embed_dim128_n_layer3_n_head1_ngram_1_nvocab_100_temperature_1.0/model_final", "80000"), 
        ("/scratch/zw2374/public/can-wikipedia-help-offline-rl-old/ngram/pretrain/checkpoints_ngram/chibiT_syn_embed_dim128_n_layer3_n_head1_ngram_1_nvocab_100_temperature_1.0_rerun/model_1", "1")
        ]        ]
