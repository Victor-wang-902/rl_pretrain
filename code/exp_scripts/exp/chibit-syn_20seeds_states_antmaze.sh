...
python exp_scripts/exp/chibit-syn_20seeds_states_antmaze.py --setting ${SLURM_ARRAY_TASK_ID} --device cpu --extend_positions --dropout 0.2 --share_input_output_proj
"