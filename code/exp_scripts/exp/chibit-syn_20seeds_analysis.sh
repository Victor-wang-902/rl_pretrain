...
python exp_scripts/exp/chibit-syn_20seeds_analysis.py --setting ${SLURM_ARRAY_TASK_ID} --device cpu --extend_positions --dropout 0.2 --share_input_output_proj --calculate_extra
python exp_scripts/exp/chibit-syn_20seeds_analysis.py --setting ${SLURM_ARRAY_TASK_ID} --device cpu --extend_positions --dropout 0.2 --share_input_output_proj --calculate_extra --compare_w_pretrain
