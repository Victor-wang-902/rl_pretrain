...
from experiment_new_antmaze import set_dt_args, experiment
import time
import argparse
...
if __name__ == '__main__':
    ...
    exp_prefix = 'dt-rerun-20seeds'
    # env, dataset and seed values will be added to the end of the folder name string
    # for each 3-tuple,
    settings = [
        'env', '', ["antmaze"],
        'dataset', '', ["umaze", "umaze-diverse", "medium-diverse", "medium-play", "large-diverse", "large-play"],
        'seed', '', [1024, 42, 666, 6331, 6049, 3785, 9329, 2901, 7929, 4598, 9051, 5599, 6183, 7282, 7127, 5575, 4493, 3406, 8958, 684],
        'model_type', '', ['dt'],
                ]
