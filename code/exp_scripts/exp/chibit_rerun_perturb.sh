...
python exp_scripts/exp/chibit_rerun_perturb.py --setting ${SLURM_ARRAY_TASK_ID} --pretrained_lm pretrain/checkpoints/chibiT_embed_dim128_n_layer3_n_head1/model_final --extend_positions --gpt_kmeans 1000 --kmeans_cache "kmeans_cache/chibiv3_lm_1000.pt" --gpt_kmeans_const 0.1  --dropout 0.2 --share_input_output_proj --device cpu --perturb_transformer_only --perturb
"