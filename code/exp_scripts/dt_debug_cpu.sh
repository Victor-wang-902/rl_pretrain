...
python exp_scripts/dt_debug_cpu.py --setting ${SLURM_ARRAY_TASK_ID} --device cpu --embed_dim 3 --max_iters 3 --num_steps_per_iter 10 --batch_size 4 --num_eval_episodes 1
"